    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <div class="panel-actions">
                <button onclick="location.href = '{{url('agent/workers/0')}}'" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> New Worker</button>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        @foreach($map as $label=>$col)
                            ...
                            @endif
                        @endforeach
                        <td><a href="{{url('agent/workers/'.$data->NRWorker)}}" class="btn btn-primary btn-sm">Edit</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
