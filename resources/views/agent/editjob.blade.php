...
<div class="wow fadeInUp">
    <div class="panel">
        <div class="panel-heading">
            <h2 class="mt-none mb-none">Jobs</h2>
            <div class="panel-actions">
                <button onclick="location.href = '{{url('agent/jobs')}}'" class="btn btn-primary btn-sm"><i class="fa fa-backward"></i> Back</button>
            </div>
        </div>
        <div class="panel-body table-responsive">
            <form class="form-horizontal form-bordered" name="edit-form" action="{{url('agent/jobs/save')}}" method="post" enctype="multipart/form-data">
                @csrf
                <?php
                $html = '';
