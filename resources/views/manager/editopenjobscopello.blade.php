    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <div class="panel-actions">
                <button onclick="location.href = '{{url('manager/workers')}}'" class="btn btn-primary btn-sm"><i class="fa fa-backward"></i> Back</button>
            </div>
        </div>
        <div class="panel-body table-responsive">
            <form class="form-horizontal form-bordered" name="edit-form" action="{{url('manager/openjobscopello/save')}}" method="post" enctype="multipart/form-data">
                @csrf
                <?php
                $html = '';
